...
!define THISAPP "..\Release\MyExLangSetup.exe"
...
Function .onInit
  ...
  ;For debug testing purposes un-comment lines below: set to language LCID to test
  push 1043
  pop $LANGUAGE ; GetOSUserinterfaceLanguage sets $LANGUAGE directly, nothing is pushed on stack
FunctionEnd
